        ...
        return(
            <HeaderWrapper>
                ...
                <Nav>
                    ...
                    <Link alt="" to="/download"><NavItem className="left">下载App</NavItem></Link>
                    {
                        login ? <NavItem className="right" onClick={logout}>退出</NavItem> : 
                        <Link to="/login" target="_blank"><NavItem className="right">登陆</NavItem></Link>
                    }
